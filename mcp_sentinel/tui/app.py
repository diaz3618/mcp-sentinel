...
from mcp_sentinel.tui.events import CapabilitiesReady, ServerStopped, StatusUpdate
...
class SentinelApp(App):
    ...
    def on_mount(self) -> None:
        ...
        from mcp_sentinel.display.console import set_status_callback
    ...
    def on_unmount(self) -> None:
        ...
        from mcp_sentinel.display.console import clear_status_callback
    ...
    def on_status_update(self, event: StatusUpdate) -> None:
        """Process a server lifecycle status update."""
